...
Peinture::Peinture(const double niveau,const int x,const int y,QGraphicsItem *parent):Defense(niveau,4+niveau/2,2,4*pow(niveau,1.5),25,60,30,parent,VIDE,PEINTURE)
{
    setX(x);
    setY(y);
    setData(0,"PEINTURE");
