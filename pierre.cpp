...
Pierre::Pierre(const double niveau,const int x,const int y,QGraphicsItem *parent):Defense(niveau,3+(niveau/2),1,10*pow(niveau,1.5),12,25,60,25,PIERRE,parent)
{
